...
export default function App() {
    ...
    const [currentClickNode, setCurrentClickNode] = useState<LogicFlow | null>(null);

    const getLFinstanceobj = (obj: LogicFlow) => {
        setLFinstanceobj(obj);
    };
    const getLFcurrentClickNode = (data: any) => {
        setCurrentClickNode(data);
    };
    useEffect(() => {
    ...
    return (
        <div className="h-screen flow-root">
            ...
            <div className="h-[calc(100%-128px)] relative w-full">
                <LogicFlowCanvas getLFinstanceobj={getLFinstanceobj} getLFcurrentClickNode={getLFcurrentClickNode}></LogicFlowCanvas>
